...
namespace AccessTest
{
    public class AccessHelper
    {
        ...
        public AccessHelper()
        {       
            conn_str = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source='" + Environment.CurrentDirectory + "\\Data.mdb'";       
        ...
        private DataTable BuildAndInitDataTable(int Field_Count)
        {
            ...
            {
                dc = new DataColumn(i.ToString()); dt_tmp.Columns.Add(dc);
            }
            return dt_tmp;
        }
        /// <summary>
