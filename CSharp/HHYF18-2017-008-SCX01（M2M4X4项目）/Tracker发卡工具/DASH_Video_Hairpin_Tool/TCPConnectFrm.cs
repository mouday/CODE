...
namespace DASH_Video_Hairpin_Tool
{
	public class TCPConnectFrm : Form
	{
		...
		private void BTConnect_Click(object sender, EventArgs e)
		{
			...
			{
				IPEndPoint remoteEP = new IPEndPoint(IPAddress.Parse(this.TxtIP.Text.Trim()), (int)short.Parse(this.TxtPort.Text.Trim()));
				Socket client = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
				client.BeginConnect(remoteEP, delegate(IAsyncResult asyncResult)
				{
